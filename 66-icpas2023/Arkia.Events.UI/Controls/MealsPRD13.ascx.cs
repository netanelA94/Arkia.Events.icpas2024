...
{
    public partial class MealsPRD13 : BaseUserControl
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            infoBox.DataSourceId = InfoBoxCode != 0 ? InfoBoxCode : 23;
            ltrNoLunch.Text = TextsController.GetText(EventId, 190, base.Lang);
        }
    }
}
