<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="ProductsPRD05.ascx.cs" Inherits="Arkia.Events.LC2014.UI.Controls.PRD05" %>
<%@ Register Src="~/Controls/InfoBoxCtrl.ascx" TagName="InfoBoxCtrl" TagPrefix="Arkia" %>
<div id="addPrdPart1PRD05">
    <div class="orangeHeader pieFix" role="heading" aria-level="2">
        <asp:Literal ID="ltrTitle" runat="server"></asp:Literal>
    </div>
    <div data-ng-controller="ARKIA.WIZARD.PRODUCTS.PRD05.productsCtrl" id="ng_Ctrl_PRD05">
            ...
            <div id="showsContent" class="hiddenClass">
                ...
                <div data-ng-if="md ||lg" role="table">
                    <div class="greyPanel marginBottom25 marginTop25" role="row">
                        ...
                        <a class="clearForm" ng-click="clearSelected()" role="button" href="#" tabindex="0">
                            <asp:Literal runat="server" Text="<%$ Resources:LocalizedText , PRD05_Clear%>" /></a>
                    </div>
                    <div class="feesBox">
                        <!--repeater-->
                        <div class="feesRow" ng-repeat="product in products | orderBy:'EXECUTION_START_DATE'" role="row">
                            <div role="gridcell">
                            ...
                            <div class="cellProductsPrice" role="gridcell">
                                <label role="CHILD_PRICE" class="lblShowPrice" data-ng-if="isChildPriceExists" aria-hidden="true">{{product.CHILD_PRICE_FMT}}</label>
                ...
                <div class="responsive col-xs-12 col-sm-12" data-ng-if="xs|| sm">
                    <div class="marginBottom25 marginTop25 col-xs-12 col-sm-12" ng-repeat="product in products | orderBy:'EXECUTION_START_DATE'">
...
<div id="addPrdPart2PRD05" style="display: none">
    <div data-ng-controller="ARKIA.WIZARD.PRODUCTS.PRD05.productsCtrl_2" id="ng_Ctrl_PRD05_2">
        <div class="orangeHeader pieFix" role="heading" aria-level="2">
            <asp:Literal ID="Literal1" runat="server"></asp:Literal>
            <asp:Literal runat="server" Text="<%$ Resources:LocalizedText , PRD05_SelectGuestsToAtractions%>" />
        </div>
                ...
                <div class="ribbonBox pieFix">
                    <div data-ng-repeat="item in products">
                        ...
                        <div class="passItem" data-ng-repeat="passItem in item.PASSENGERS">
                            ...
                            <select role="FLIGHT_ACM_PRD04" class="selectName selectNamePrd05" data-ng-model="passItem.SELECT_CUSTOMER_NO"
...
<div id="buttonNextAddPrdPRD05" class="buttonNext col-xs-12 col-sm-12" style="display: none">
    <a class="btnContinue pieFix" href="#" role="button">
        <div class="btnContinueInner">
            <asp:Literal runat="server" Text="<%$ Resources:LocalizedText , ContinuButton%>" />
        </div>
