<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="ProductsPRD07.ascx.cs" Inherits="Arkia.Events.LC2014.UI.Controls.ProductsPRD07" %>
<%@ Register Src="~/Controls/InfoBoxCtrl.ascx" TagName="InfoBoxCtrl" TagPrefix="Arkia" %>
<div id="addPrdPart1PRD07">
    <div class="orangeHeader pieFix" role="heading" aria-level="2">
        <asp:Literal ID="ltrTitle" runat="server"></asp:Literal>
    </div>
    <div data-ng-controller="ARKIA.WIZARD.PRODUCTS.PRD07.productsCtrl" id="ng_Ctrl_PRD07">
            ...
            <div id="showsContent" class="hiddenClass">
                ...
                <div data-ng-if="md ||lg" role="table">
                    <div class="greyPanel marginBottom25 marginTop25" role="row">
                        ...
                        <div class="cellProductsPrice" ng-if="!isChildPriceExists" role="columnheader" aria-label="{{!isChildPriceExists}}">
                        </div>
                    ...
                    <div class="feesBox">
                        ...
                        <div class="feesRow" ng-repeat="product in products" role="row">
                            ...
                            <div class="cellProductsPrice" role="gridcell">
                                <label role="ADULT_PRICE" class="lblShowPrice">
                                    {{product.ADULT_PRICE_FMT}}</label>
                            </div>
                            <div class="cellProductsPrice" role="gridcell">
                                <label role="CHILD_PRICE" class="lblShowPrice" data-ng-if="isChildPriceExists">
                ...
                <div class="responsive col-xs-12 col-sm-12" data-ng-if="xs|| sm">
                    ...
                    <a class="clearForm col-xs-12 col-sm-12" ng-click="clearSelected()" role="button">
                        <asp:Literal runat="server" Text="<%$ Resources:LocalizedText , PRD05_Clear%>" /></a>
                </div>
...
<div id="addPrdPart2PRD07" style="display: none">
    <div data-ng-controller="ARKIA.WIZARD.PRODUCTS.PRD07.productsCtrl_2" id="ng_Ctrl_PRD07_2">
        <div class="orangeHeader pieFix" role="heading" aria-level="2">
        ...
        <div id="buttonNextAddPrdPRD07" class="buttonNext col-xs-12 col-sm-12">
            <a class="btnContinue pieFix" href="#" role="button">
                <div class="btnContinueInner">
                    <asp:Literal runat="server" Text="<%$ Resources:LocalizedText , ContinuButton%>" />
                </div>
